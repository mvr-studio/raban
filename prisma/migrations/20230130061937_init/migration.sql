...
CREATE TABLE "Event" (
    ...
    CONSTRAINT "Event_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "EventState" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
-- CreateIndex
CREATE UNIQUE INDEX "EventState_slug_key" ON "EventState"("slug");
